...
const testimonials = [
  {
    name: "Monica John",
    role: "Dar es Salaam • Content creator",
    type: "CREATOR",
    text: "Posting my clips on WhapVibez feels simple and fun. I go live, connect with my people and I can actually see my content bringing in real income.",
    color: "from-primary to-secondary",
    shadow: "shadow-primary/20",
  },
  {
    name: "Samuel Mwita",
    role: "Mwanza • Online shopper",
    type: "SHOPPER",
    text: "I scroll, see something I like and check out in a few taps. No long forms, no drama – it just works and my orders arrive on time.",
    color: "from-blue-500 to-indigo-600",
    shadow: "shadow-blue-500/20",
  },
  {
    name: "Mama Neema Boutique",
    role: "Arusha • Small business owner",
    type: "VENDOR",
    text: "I opened a small shop inside WhapVibez and people discovered my products through videos. Now I manage orders and chats from one place only.",
    color: "from-purple-500 to-pink-600",
    shadow: "shadow-purple-500/20",
  },
  {
    name: "Kelvin Swalehe",
    role: "Dodoma • Live streamer",
    type: "STREAMER",
    text: "Going live here feels very natural. Gifts turn into real payouts and the chat is fast, so it’s easy to keep the vibe moving.",
    color: "from-emerald-500 to-teal-600",
    shadow: "shadow-emerald-500/20",
  },
  {
    name: "Asha & Friends",
    role: "Morogoro • Community group",
    type: "COMMUNITY",
    text: "We hang out in our own space, share reels and support local brands we love. It’s social, but it still feels safe and controlled.",
      ...
      <section id="home" className="w-full max-w-7xl mx-auto px-6 pt-32 md:pt-40 pb-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 relative z-10 min-h-[85vh]">
        <div className="w-full lg:w-[45%] flex flex-col items-center text-center lg:items-start lg:text-left gap-6 z-30 pt-4 md:pt-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex flex-row items-center justify-center lg:justify-start gap-3 md:gap-4 mt-4 w-full">
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.whapvibez.app&hl=en"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 sm:gap-3 bg-white border border-gray-200 text-gray-900 px-4 sm:px-6 py-2.5 sm:py-3 rounded-2xl hover:bg-gray-50 transition-all transform hover:scale-105 shadow-sm"
            >
      ...
      <section id="testimonials" className="w-full relative z-30 pt-10 pb-32 overflow-hidden">
        ...
        <div className="text-center mb-6 md:mb-8 relative z-20">
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-3 tracking-tight">
            Loved by creators in{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
              Tanzania.
            </span>
          </h2>
          <p className="text-gray-500 text-lg font-medium px-4">
            Real voices from people using WhapVibez every day.
          </p>
        </div>
      ...
      <section id="faq" className="w-full max-w-5xl mx-auto px-6 pb-16 relative z-30">
        <div className="max-w-2xl mx-auto text-center mb-8">
          ...
          <p className="text-gray-500 text-sm md:text-base font-medium">
            Short answers to the things people ask most about how WhapVibez works, how you earn, and how we keep you safe.
          </p>
        </div>
          ...
          {homepageFaqs.map((item, index) => (
            ...
            >
              <summary className="flex items-center justify-between cursor-pointer list-none">
                <h3 className="text-sm sm:text-base font-semibold text-gray-900 mr-4">
                  {item.question}
                </h3>
          ...
          <div className="relative z-10 w-full md:w-1/2 flex flex-col items-center text-center md:items-start md:text-left pb-10 md:pb-12">
            ...
            <div className="flex flex-row items-center justify-center md:justify-start gap-2 sm:gap-3 w-full">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-1 sm:flex-none items-center justify-center gap-1.5 sm:gap-3 bg-white text-gray-900 px-2 sm:px-5 py-2.5 sm:py-3 rounded-2xl hover:bg-gray-50 transition-all transform hover:scale-105 shadow-xl"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10 mb-16">
            ...
            <div className="flex flex-col text-left">
              ...
              <div className="flex flex-col gap-3">
                <a href="/legal/terms" className="text-gray-500 font-medium hover:text-primary transition-colors text-sm">Terms &amp; conditions</a>
                <a href="/legal/privacy-policy" className="text-gray-500 font-medium hover:text-primary transition-colors text-sm">Privacy Policy</a>
              </div>
            </div>
